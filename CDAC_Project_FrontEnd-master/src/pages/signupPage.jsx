...
import { CreateAdminUser } from "../service/authentication";
...
function SignUpPage(params) {
  ...
  async function handleSignUp(event) {
    ...
    const userObj = {
      admin_email: document.getElementById("email_field").value,
      password: document.getElementById("password_field").value,
      admin_name: document.getElementById("name_field").value,
    ...
    try {
      const data = await CreateAdminUser(userObj);
